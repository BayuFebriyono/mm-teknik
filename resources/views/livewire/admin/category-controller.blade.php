                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr wire:key="{{ $category->id }}">
                            ...
                            <td><span role="button" class="btn btn-warning" wire:click="edit('{{ $category->id }}')"><i class="fa-solid fa-pen-to-square"></i></span>
                                <span role="button" class="btn btn-danger" wire:click="delete('{{ $category->id }}')"><i class="fa-solid fa-trash-can"></i></span>
                            </td>
                        </tr>
                    @endforeach
