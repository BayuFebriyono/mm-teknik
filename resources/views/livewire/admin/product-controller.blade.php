                ...
                <form wire:submit="store">
                    <div class="row">
                            ...
                            <div class="">
                               <select  id="kategori" class="form-select" wire:model="categoryId" required>
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" wire:key="{{ $category->id }}" >{{ $category->kategori }}</option>
                                @endforeach
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-1 col-md-6">
                            ...
                            <div class="">
                             <input type="file" id="Photo" class="form-control" wire:model="urlPhoto" required>
                            </div>
                        </div>
                    </div>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr wire:key="{{ $product->id }}">
                            ...
                            <td><span role="button" class="btn btn-warning" wire:click="edit('{{ $product->id }}')"><i
